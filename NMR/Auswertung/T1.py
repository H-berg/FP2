...
plt.errorbar(time, real_off+B, yerr=real_off_err, capsize=3, fmt='.', color="#505054", label="Mess-Signal")
plt.plot(t, exp(t, *params)+B, color="#98989e")
plt.annotate(s=r'$T_1$ = ' + str(round(params[3],2)) + " ms", xy=(params[3], 0.78), xytext=(params[3]-9,0.99), arrowprops=dict(color="black", arrowstyle="simple"))
