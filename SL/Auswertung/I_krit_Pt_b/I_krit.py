...
t1, RMG1, URL1, IRL1  = np.genfromtxt('A4b_08A.txt',  unpack=True) # s | ohm | mV | A
t2, RMG2, URL2, IRL2  = np.genfromtxt('A4b_06A.txt', unpack=True) # s | ohm | mV | A
URL2 = -URL2
...
for i in range(1,3):
    ...
    ax2.plot(np.ones(20)*T(RMG[TK]), np.linspace(-0.5,12,20), "--",color="#e5961c", linewidth=0.5, zorder=2)
